            ...
            <div className="flex-1 overflow-y-auto p-6 space-y-8 pb-40 custom-scrollbar text-[11px] leading-relaxed text-white/70">
                ...
                <section className="space-y-3">
                    ...
                    <div className="space-y-3 uppercase">
                        ...
                        <p>1.2. Использование мини-приложения <span className="text-white font-bold">«Кроличья Нора»</span> (далее — Приложение), нажатие кнопок «Продолжить», «Оплатить», «Получить доступ» или совершение иных действий по использованию Приложения означает полное и безоговорочное принятие (акцепт) Пользователем условий настоящего Соглашения, а также Политики конфиденциальности.</p>

                        <div className="p-4 border border-white/10 bg-white/5 text-[10px] leading-relaxed">
                ...
                <section className="space-y-3">
                    ...
                    <div className="space-y-2 uppercase">
                        ...
                        <p>2.4. Полный доступ ко всему контенту и функционалу предоставляется на платной основе путём совершения единоразового платежа.</p>
                    </div>
                </section>
                ...
                <section className="space-y-3">
                    ...
                    <div className="space-y-3 uppercase">
                        <p>3.1. Оплата производится через платёжный сервис <span className="text-white font-bold">ЮKassa</span>.</p>
                        <p>3.2. После успешного подтверждения платежа доступ предоставляется на основании уникального идентификатора пользователя в мессенджере <span className="text-white font-bold">MAX Messenger</span> и сохраняется в локальное хранилище устройства.</p>
                        <p>3.3. Владелец не несет ответственности за утрату доступа в случае удаления данных приложения или смены аккаунта в мессенджере пользователем.</p>

                        <div className="p-3 border border-[#00ffcc]/20 bg-[#00ffcc]/5 text-[10px]">
                            3.4. В соответствии со ст. 26.1 Закона РФ «О защите прав потребителей», возврат денежных средств за предоставленный цифровой контент (лицензию) после начала его использования не осуществляется.
                        </div>
                    </div>
                </section>
                ...
                <section className="space-y-3">
                    ...
                    <div className="space-y-2 uppercase">
                        ...
                        <p>4.2. Используя Приложение, Пользователь подтверждает, что ему исполнилось 18 лет и он ознакомлен с тем, что Приложение содержит материалы эротического и/или взрослого характера.</p>
                    </div>
                </section>
                ...
                <section className="space-y-3">
                    ...
                    <div className="space-y-2 uppercase">
                        <p>5.1. Владелец предоставляет Пользователю простую (неисключительной) лицензию на использование Приложения исключительно в личных некоммерческих целях.</p>
                        <p>5.2. Любое копирование, распространение или коммерческое использование контента Приложения строго запрещено.</p>
                    </div>
                </section>
                ...
                <section className="space-y-3">
                    ...
                    <div className="space-y-2 uppercase">
                        <p>6.1. Приложение предоставляется «как есть» (as is). Владелец не гарантирует бесперебойную работу Приложения.</p>
                ...
                <section className="space-y-3">
                    <div className="flex items-center gap-2 text-[#00ffcc]">
                        <Mail size={14} />
                        <span className="text-[10px] font-black uppercase tracking-widest">07. Контакты</span>
                    </div>
                    <p>По вопросам технической поддержки:</p>
                    <p className="text-white font-bold">rabbithole.help@vk.com</p>
                </section>
