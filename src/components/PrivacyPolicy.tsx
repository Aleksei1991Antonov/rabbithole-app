            ...
            <div className="flex-1 overflow-y-auto p-6 space-y-8 pb-40 custom-scrollbar text-[11px] leading-relaxed text-white/70">
                ...
                <section className="space-y-3">
                    ...
                    <div className="space-y-2 uppercase">
                        <p>1.1. Настоящая Политика конфиденциальности (далее — Политика) определяет порядок обработки и защиты персональных данных Пользователей мини-приложения <span className="text-white font-bold">«Кроличья Нора»</span> (далее — Приложение), работающего в мессенджере <span className="text-white font-bold">MAX Messenger</span>.</p>
                        ...
                        <p>1.3. Использование Приложения означает согласие Пользователя с условиями настоящей Политики.</p>
                    </div>
                </section>
                ...
                <section className="space-y-3">
                    ...
                    <div className="space-y-3 uppercase">
                        ...
                        <p className="p-3 border border-[#00ffcc]/20 bg-[#00ffcc]/5 text-[10px]">
                        ...
                        <ul className="list-disc list-inside pl-4 space-y-1 text-white/80">
                            <li>Имя пользователя в MAX Messenger (для персонализации игрового процесса);</li>
                            <li>Язык интерфейса устройства (для выбора локализации);</li>
                            <li>Техническая информация об устройстве (модель, ОС, версия, разрешение экрана);</li>
                            <li>Данные о взаимодействии с Приложением (время сессии, действия в интерфейсе).</li>
                        </ul>

                        <p className="p-3 border border-[#00ffcc]/10 bg-white/5 text-[9px]">
                            Примечание: Данные профиля MAX Messenger обрабатываются локально для работы игровых механик и не передаются на внешние серверы Оператора.
                        </p>
                ...
                <section className="space-y-3">
                    ...
                    <div className="space-y-2 uppercase">
                        ...
                        <p>• Персонализация игрового процесса на основе данных профиля MAX Messenger;</p>
                ...
                <section className="space-y-3">
                    ...
                    <div className="space-y-2 uppercase">
                        ...
                        <p className="pt-2">Для реализации указанных прав Пользователь может обратиться по адресу: <span className="text-white font-bold">rabbithole.help@vk.com</span></p>
                    </div>
                </section>
                ...
                <section className="space-y-3">
                    <div className="flex items-center gap-2 text-[#00ffcc]">
                        <Mail size={14} />
                        <span className="text-[10px] font-black uppercase tracking-widest">08. Контактная информация</span>
                    </div>
                    <div className="space-y-2 uppercase">
